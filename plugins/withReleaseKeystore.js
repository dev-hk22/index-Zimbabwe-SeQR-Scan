...
const withReleaseKeystore = (config) => {
  ...
  config = withGradleProperties(config, (config) => {
    ...
    setProp('MYAPP_RELEASE_KEY_ALIAS', process.env.EXPO_PUBLIC_RELEASE_KEY_ALIAS || '');
    setProp('MYAPP_RELEASE_STORE_PASSWORD', process.env.EXPO_PUBLIC_RELEASE_STORE_PASSWORD || '');
    setProp('MYAPP_RELEASE_KEY_PASSWORD', process.env.EXPO_PUBLIC_RELEASE_KEY_PASSWORD || '');
